...
import mypackage.MYFIRSTPROJECTCODE;
 ...
 */
public class MYFIRSTPROJECTCODETest {

	AnalysisEngineDescription component;

	@Before
	public void setup() throws ResourceInitializationException {
		component = createEngineDescription(MYFIRSTPROJECTCODE.class);
	}
	...
	private JCas runComponent(String text, boolean caseSensitive) throws UIMAException {
		component.getAnalysisEngineMetaData().getConfigurationParameterSettings()
				.setParameterValue(MYFIRSTPROJECTCODE.PARAM_CASE_SENSITIVE, caseSensitive);
